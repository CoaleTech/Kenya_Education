...
def before_install():
    ...
    if not frappe.db.exists("Module Def", "Education"):
        frappe.throw(
            _("Frappe Education app is required but not installed. "
...
def after_install():
    ...
    try:
        ...
        frappe.db.rollback()
        frappe.log_error(f"Frappe Education Kenya installation failed: {str(e)}")
        raise
...
def after_migrate():
    ...
    Ensures custom fields exist after framework upgrades.
    """
    create_custom_fields()
    frappe.db.commit()
...
def seed_cbc_levels():
    ...
    cbc_levels = [
        {"level_code": "ECDE_PP1", "level_name": "Pre-Primary 1", "education_sector": "Pre-Primary", "years_of_study": 1, "sequence_order": 1, "moef_level_code": "PP1", "is_transition_level": 0},
        {"level_code": "ECDE_PP2", "level_name": "Pre-Primary 2", "education_sector": "Pre-Primary", "years_of_study": 1, "sequence_order": 2, "moef_level_code": "PP2", "is_transition_level": 0},
        {"level_code": "PRI_G1", "level_name": "Grade 1", "education_sector": "Primary", "years_of_study": 1, "sequence_order": 3, "moef_level_code": "G1", "is_transition_level": 0},
        {"level_code": "PRI_G2", "level_name": "Grade 2", "education_sector": "Primary", "years_of_study": 1, "sequence_order": 4, "moef_level_code": "G2", "is_transition_level": 0},
        {"level_code": "PRI_G3", "level_name": "Grade 3", "education_sector": "Primary", "years_of_study": 1, "sequence_order": 5, "moef_level_code": "G3", "is_transition_level": 0},
        {"level_code": "PRI_G4", "level_name": "Grade 4", "education_sector": "Primary", "years_of_study": 1, "sequence_order": 6, "moef_level_code": "G4", "is_transition_level": 0},
        {"level_code": "PRI_G5", "level_name": "Grade 5", "education_sector": "Primary", "years_of_study": 1, "sequence_order": 7, "moef_level_code": "G5", "is_transition_level": 0},
        {"level_code": "PRI_G6", "level_name": "Grade 6", "education_sector": "Primary", "years_of_study": 1, "sequence_order": 8, "moef_level_code": "G6", "is_transition_level": 1, "examination_body": "KNAT", "national_exam_name": "KPSEA"},
        {"level_code": "JSS_G7", "level_name": "Grade 7", "education_sector": "Junior Secondary", "years_of_study": 1, "sequence_order": 9, "moef_level_code": "G7", "is_transition_level": 0},
        {"level_code": "JSS_G8", "level_name": "Grade 8", "education_sector": "Junior Secondary", "years_of_study": 1, "sequence_order": 10, "moef_level_code": "G8", "is_transition_level": 0},
        {"level_code": "JSS_G9", "level_name": "Grade 9", "education_sector": "Junior Secondary", "years_of_study": 1, "sequence_order": 11, "moef_level_code": "G9", "is_transition_level": 1, "examination_body": "KNAT", "national_exam_name": "KJSEA"},
        {"level_code": "SSS_G10", "level_name": "Grade 10", "education_sector": "Senior Secondary", "years_of_study": 1, "sequence_order": 12, "moef_level_code": "G10", "is_transition_level": 0},
        {"level_code": "SSS_G11", "level_name": "Grade 11", "education_sector": "Senior Secondary", "years_of_study": 1, "sequence_order": 13, "moef_level_code": "G11", "is_transition_level": 0},
        {"level_code": "SSS_G12", "level_name": "Grade 12", "education_sector": "Senior Secondary", "years_of_study": 1, "sequence_order": 14, "moef_level_code": "G12", "is_transition_level": 1, "examination_body": "KNEC", "national_exam_name": "KACSE"},
    ]
...
def create_workspaces():
    """Create the Kenya Education workspace."""
    # Workspaces are typically created via JSON fixtures or directly
    # This is a simplified version — full workspace definition would be in a JSON fixture
    pass
